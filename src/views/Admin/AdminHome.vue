...
<template>
 <div class="container-scroller">
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row adminspace">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="" class="me-2" alt="image"> David Grey
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="" class="me-2" alt="image"> Stella Johnson
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="" class="me-2" alt="image"> Marina Michel
                            </td>
                          ...
                          <tr>
                            <td>
                              <img src="" class="me-2" alt="image"> John Doe
                            </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pe-1">
                        <img src="" class="mb-2 mw-100 w-100 rounded" alt="image">
                    ...
                    <div class="d-flex mt-5 align-items-top">
                      <img src="" class="img-sm rounded-circle me-3" alt="image">
