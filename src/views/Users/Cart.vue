...
<template>
  <div class=""
    v-if="cart.cartProduct == null || cart.cartProduct == '' || cart.cartProduct == undefined || cart.cartProduct == {}">
      ...
      <div class="row no-gutters">
        <div class="col-md-8">
          <div class="product-details mr-2">
            <RouterLink to="/products" class="d-flex flex-row align-items-center text-decoration-none text-dark"><i
                class="fa fa-long-arrow-left"></i><span class="ms-2">Continue Shopping</span></RouterLink>
            <hr>
            <h6 class="mb-0">Shopping cart</h6>
            <div class="d-flex justify-content-between"><span>You have {{ cart.totalItems }} items added in your
                cart</span>
              ...
              <div class="d-flex justify-content-between align-items-center mt-3 p-2 items rounded">
                ...
                <div class="d-flex flex-row align-items-center">
                  <span class="d-flex"><small class="productM"><b>Product Quendity : </b></small>
                    <input v-model="userproduct.QTY" type="number" class="form-control userProductQTY"
                      aria-label="QTY input" aria-describedby="inputGroup-sizing-sm">
                  </span>
                  <span class="d-block ms-3 font-weight-bold"><b>${{ userproduct.product.price }}</b></span>
                  <RouterLink :to="{ name: 'specification', params: { id: userproduct.product.id } }"><i
                      class="fa-regular fa-eye ms-2"></i></RouterLink>
                  <i @click="cart.removeProduct(userproduct.product.id)" class="fa-solid fa-trash-can ms-2"
        ...
        <div class="col-md-4">
          <div class="payment-info">
            ...
            <div>
              ...
              <input type="text" class="form-control credit-inputs" placeholder="Disabled input" aria-label="Disabled input example" disabled>
            </div>
            <div>
            ...
            <div class="d-flex justify-content-between information">
              ...
              <span>{{ cart.totalItems }} pcs</span>
            </div>
            <div class="d-flex justify-content-between information">
              <span>Total Price</span><span>${{ cart.totalPrice }}</span>
            </div>
            <div class="d-flex justify-content-between information"><span>Total(Incl. taxes)</span>
              <span>${{ cart.totalPrice }}.00</span>
            </div>
            <RouterLink to="/check-out" class="btn btn-primary btn-block d-flex justify-content-between mt-3" type="button">
              <span> ${{ cart.totalPrice }}.00</span>
              <span>Checkout<i class="fa fa-long-arrow-right ms-1"></i></span>
            </RouterLink>
          </div>
        </div>
      </div>
